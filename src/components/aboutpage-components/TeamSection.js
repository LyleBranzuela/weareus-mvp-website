        ...
        <div className="row">
          ...
          <div className="col">
            ...
            <p id="team-description">
              ...
              process from when I first thought of We are Us through to building
              the plan and beyond. And I couldn't have hoped for a more
              qualified mentor. With a background in print and digital design,
              Fraser's been the judge in national and international design
              awards, so really knows what looks good. His contribution to New
              Zealand design was recognised in 2011 when he was awarded the
              prestigious Designers Institute Black Pin Award.
            </p>
        ...
        <div className="row">
          <div className="col">
            ...
            <p id="team-description">
              ...
              work that they do that we've teamed up with them so they can guide
              us in our marketing strategy. These guys are experts at what they
              do. Since 2012, Silverlane have advised over 700 businesses on
              digital and brand strategy. They've been able to draw some
              conclusions about what works and what really doesn't.
            </p>
