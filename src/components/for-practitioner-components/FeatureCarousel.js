...
class FeatureCarousel extends React.Component {
  ...
  getPageContent = async () => {
    ...
    pageContent.getImage1 = JSON.stringify(getImage1.data.imageURL).replace(/"/g, "");
    pageContent.getImage2 = JSON.stringify(getImage2.data.imageURL).replace(/"/g, "");
    pageContent.getImage3 = JSON.stringify(getImage3.data.imageURL).replace(/"/g, "");
